...
// Runs the arena timers on demand so a test can step through each beat of a power move.
...
function createAppFixture(game, globals = {}) {
  const ids = [
    ...
    'speechControls', 'speechInvite', 'heroArt', 'buddyArt', 'comboBadge', 'comboCount', 'stageEffects',
  ];
  ...
  return {
    elements, played, effects, sound, audioElements, audioState, championCards, speechLanguageButtons, topicTabs, document, clock,
